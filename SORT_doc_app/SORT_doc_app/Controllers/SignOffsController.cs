...
{
    public class SignOffsController : BaseDocumentController<SignOff>
    {
        protected override DbSet<SignOff> getDbSet()
        {
            return db.SignOffs;
        }
